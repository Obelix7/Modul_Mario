...
public class Level3 extends World
{
    ...
    private void spawnBrightstruction(){
        
    BrightConstruction brightConstruction1 = new BrightConstruction(); //Neues Objekt erzeugen
    addObject(brightConstruction1, 440, 565); //Objekt platzieren
    
    BrightConstruction brightConstruction2 = new BrightConstruction(); //Neues Objekt erzeugen
    addObject(brightConstruction1, 625, 579); //Objekt platzieren
    
    BrightConstruction brightCobstruction3 = new BrightConstruction(); //Neues Objekt erzeugen
    addObject(brightConstruction1, 798, 463); //Objekt platzieren
